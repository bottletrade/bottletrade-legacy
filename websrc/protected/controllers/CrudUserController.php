...
class CrudUserController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BaseUser']))
		{
			$model->attributes=$_POST['BaseUser'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('BaseUser');
	...
	{
		$model=new BaseUser('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BaseUser']))
			$model->attributes=$_GET['BaseUser'];
	...
	{
		$model=BaseUser::model()->findByPk($id);
		if($model===null)
