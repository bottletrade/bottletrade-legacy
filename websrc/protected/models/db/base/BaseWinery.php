 ...
 *
 * The followings are the available columns in table 'winery':
 * @property integer $ID
 ...
 */
class BaseWinery extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'isos' => array(self::HAS_MANY, 'Iso', 'WineryID'),
			'wines' => array(self::HAS_MANY, 'Wine', 'WineryID'),
	 ...
	 * @return BaseWinery the static model class
	 */
