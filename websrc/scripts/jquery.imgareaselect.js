...
$.imgAreaSelect = function (img, options) {
    ...
    function adjust() {
        ...
        // CUSTOM - START
        // check if img is rotated, swap width/height if so
	    var rotation = $outer.data('rotated');
	    if (((rotation / 90) % 2) == 1) {
	    	// rotated image
	    ...
	    translateY = $outer.data('translatedY') || 0;
	    translateX = $outer.data('translatedX') || 0;
	    imgOfs.top += translateY;
	    imgOfs.left -= translateX;
        // CUSTOM - END
